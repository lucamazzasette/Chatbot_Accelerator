...
describe("QuestionInput Component", () => {
  ...
  //     />
  //   );
  //   const microphonebtn = screen.getByRole('button', { name: 'Microphone button' });
  ...
  //   );
  //   const microphonebtn = screen.getByRole('button', { name: 'Microphone button' });
  //   fireEvent.keyDown(microphonebtn, { key: "Enter", code: "Enter", charCode: 13 });
  ...
  //     />
  //   );
  //   const sendregularele =screen.queryByRole('button', { name: /SendRegular/i });
